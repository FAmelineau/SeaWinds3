---
title: "Cluster analysis ATPU spring"
author: "FA"
date: "24 2 2022"
...
top_row = plot_grid(map, plot1, labels = c("g","h") , rel_widths = c(1.7, 1))

print(top_row) 

ggsave("Fig_clust_1_ATPU_spring_samescale.png", plot = top_row , width = 6, height = 3, units = "in")


```

```{r plot publi supp plot 2, echo = FALSE}
...
ggsave("Fig_clust_ATPU_spring_supp_v3.png", plot = final , width = 8, height = 9, units = "in")
...
write.csv(sum, file = "summary_ATPU_spring.csv")
