---
title: "Cluster analysis BLKI autumn"
author: "FA"
date: "22 3 2022"
...
tables::table_options(knit_print = TRUE)
```
...
z2 <- bird_data_col %>% dplyr::filter( season == myseason)
...
# replacement of dark blue to pink (asked by a reviewer to change color)

clustcol[5] = clustcol[7]
...
top_row = plot_grid(map, plot1, labels = c("a","b") , rel_widths = c(1.7, 1))

print(top_row) 

ggsave("Fig_clust_1_BLKI_autumn_samescale.png", plot = top_row , width = 6, height = 3, units = "in")
...
ggsave("Fig_clust_BLKI_autumn_supp_v3.png", plot = final , width = 8, height = 9, units = "in")
...
write.csv(sum, file = "summary_BLKI_autumn.csv")
